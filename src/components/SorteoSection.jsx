      ...
      <AnimatePresence mode="wait">
        {sorteoActivo ? (
          ...
          <motion.div
            ...
            exit={{ opacity: 0 }}
            className="relative overflow-hidden rounded-2xl border border-white/20 bg-gradient-to-br from-white/10 via-oscuro-800 to-oscuro-900 p-6 sm:p-8 text-center shadow-xl shadow-white/5"
          >
            {/* Glow decorativo */}
            ...
            <div className="relative z-10 flex flex-col items-center gap-3">
              ...
              <div className="mt-2 px-5 py-2 rounded-full bg-white/10 border border-white/20 text-white font-bold text-sm tracking-wide">
                🎁 Premio: {s.premio}
              </div>
            </div>
          </motion.div>
          ...
          <motion.div
            ...
            animate={{ opacity: 1, y: 0 }}
            exit={{ opacity: 0 }}
            className="relative overflow-hidden rounded-2xl border border-white/10 bg-gradient-to-br from-oscuro-950 via-oscuro-900 to-oscuro-800 p-6 sm:p-8 text-center shadow-lg"
          >
            {/* Glow sutil */}
            <div className="absolute top-0 left-1/2 -translate-x-1/2 w-64 h-24 bg-white/5 rounded-full blur-3xl pointer-events-none" />
